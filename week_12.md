...
2. [Project 3](#project-3-critique)
3. [Reading Discussion #4](#reading-discussion)
...
p5.js has a lot of community built libraries that we can build on top of, of which you can see the full list here: https://p5js.org/libraries/directory/

For your final project, you will pick one of these libraries to play around with. Your proposal will give you time to poke through the libraries and make some decisions as to which one you will work with. Things to consider when choosing a library:
1) What does the documentation look like?
2) Is it well-supported by the p5 community? When was the last time the library was updated?
3) Are there a lot of tutorials using the library?
4) Is it an interesting topic to you?

Some libraries I have used and like:
* [ml5.js](https://docs.ml5js.org/#/)
* [p5 touch gui](https://github.com/L05/p5.touchgui)
